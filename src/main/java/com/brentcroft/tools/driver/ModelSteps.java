...
public class ModelSteps
{
    ...
    @Given( "^(apply steps|steps|EL)( |after | after all | before all )[^\"]*\"([^\"]*)\"$" )
    public void apply_steps_inline( String dummy, String after, String steps )
    {
    ...
    @Given( "^(apply steps|steps|EL)(| after| after all| before all)[^\"]*$" )
    public void apply_steps_multiline( String dummy, String after, String steps )
    {
        apply_steps_inline( dummy, after, steps );
    }
